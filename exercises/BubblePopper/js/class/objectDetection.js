...
/**Recap for object detection via webCam
 1. p5: create capture: createCapture(VIDEO/AUDIO, [callback function])
 2. p5: optional hide the DOM element: .hide()
 3. ml5: start detection model: ml5.objectDetector(modelName/jsonURL of pre-trained model, ?options (threshold, {} by default), ?callback) 
 4. ml5: onject detection: .detect(input(image or video), ?callback)
 5.
