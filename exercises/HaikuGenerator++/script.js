...
function myCursor(e) {
    ...
    customCursor.style.top = `${mouseY + 100}px`;
    customCursor.style.left = `${mouseX + 100}px`;
}
...
function changeLine(event) {
  fadeOut(event.target, 1, 2);
  customCursor.innerText = line1.innerText;
  if (customCursor.innerText === line3.innerText) {
...
*/
function fadeOut(element, opacity, padding) {
